...
def run(arch, filepath):
    os.system(
        "python compress_classifier.py -a=" + arch + " --data ../../data.cifar --workers 3 --batch-size 128 --evaluate --confusion --adv 1 --resume-from ../../outputsdata/" + filepath + "/checkpoint.pth.tar --out-dir ../../outputsdata/eval/resnet44kd/ --cpu --quantized 8")
...
second_run_list = [('vgg16_cifar', 'vgg16-base(50)'), ('vgg16_cifar', 'vgg16-base(50)-pruning'),
