...
run_list = [('resnet44_cifar', 'wideresnet-kd-resnet44-pruning'),('resnet20_cifar', 'resnet20'),('resnet20_cifar', 'resnet20-apgpruning'), ('simplenet_cifar ', 'resnet20-realkd'),
            ...
            ('resnet32_cifar', 'resnet44-kd-resnet32'), ('resnet32_cifar', 'resnet44-kd-resnet32-pruning'),
