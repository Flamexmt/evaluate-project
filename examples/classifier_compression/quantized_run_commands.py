...
def run(arch, filepath):
    os.system(
        "python compress_classifier.py -a=" + arch + " --data ../../data.cifar --workers 3 --batch-size 128 --evaluate --confusion --adv 1 --resume-from ../../outputsdata/" + filepath + "/checkpoint.pth.tar --out-dir ../../outputsdata/eval/ --quantized 8 --cpu")


run_list = [('resnet44_cifar', 'resnet44-apgpruning'),('vgg16_cifar', 'vgg16-base(50)'), ('vgg16_cifar', 'vgg16-base(50)-pruning'),
            ...
            ('resnet44_cifar', 'wideresnet-kd-resnet44-pruning'),('resnet32_cifar', 'resnet44-kd-resnet32'), ('resnet32_cifar', 'resnet44-kd-resnet32-pruning'),
                  ('resnet26_cifar', 'resnet44-kd-resnet26'), ('resnet32_cifar', 'resnet44-kd-resnet26-pruning'),('resnet20_cifar', 'resnet20'), ('resnet20_cifar', 'resnet20-apgpruning'),
            ('simplenet_cifar ', 'resnet20-realkd'),
            ('simplenet_cifar', 'resnet20-realkd-apgpruning'), ('resnet44_cifar', 'resnet44'),
             ('resnet20_cifar', 'resnet44-kd'),
