...
data_path = 'D:\study\model-compression\git-hub\evaluate-project\evaluate_tools\data/imagenet_1k'
saved_model_dir = 'D:\study\model-compression\git-hub\evaluate-project\evaluate_tools\data'
...
import os
myModel = load_model().to('cpu')
myModel.eval()
print('1231231',torch.backends.quantized.engine)
