"""
The main file, which exposes the robustnessTool command-line tool, detailed in
...
def setup_args(args):
    ...
    :mod:`robustnessTool.defaults`, and also perform a sanity check to make sure no
    args are missing.
    '''
