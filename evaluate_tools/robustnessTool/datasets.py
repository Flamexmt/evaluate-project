...
abstract class :class:`robustnessTool.datasets.DataSet`.

Currently supported datasets:

- ImageNet (:class:`robustnessTool.datasets.ImageNet`)
- RestrictedImageNet (:class:`robustnessTool.datasets.RestrictedImageNet`)
- CIFAR-10 (:class:`robustnessTool.datasets.CIFAR`)
- CINIC-10 (:class:`robustnessTool.datasets.CINIC`)
- A2B: horse2zebra, summer2winter_yosemite, apple2orange
  (:class:`robustnessTool.datasets.A2B`)
...
class DataSet(object):
    ...
    def get_model(self, arch, pretrained):
        ...
        `model_utils.make_and_restore_model </source/robustnessTool.model_utils.html>`_.
...
>>> import robustnessTool.datasets
