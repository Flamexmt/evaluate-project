...
"""
Arguments essential for the :meth:`robustnessTool.train.train_model` function if
...
into :meth:`robustnessTool.train.train_model` or :meth:`robustnessTool.train.eval_model`
...
def check_and_fill_args(args, arg_list, ds_class):
    ...
    Args:
        ...
        ds_class (type) : A dataset class name (i.e. a
            :class:`robustnessTool.datasets.DataSet` subclass name)
