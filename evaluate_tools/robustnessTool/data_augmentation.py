...
:meth:`robustnessTool.data_augmentation.TRAIN_TRANSFORMS_DEFAULT(32)` for CIFAR-10.
"""
...
:meth:`robustnessTool.data_augmentation.TEST_TRANSFORMS_DEFAULT`, takes in an image
side length.
"""
